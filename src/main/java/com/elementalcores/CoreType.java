...
public enum CoreType {
    ...
    WATER("Water", "#1E90FF", 1002, Particle.WATER_SPLASH, Material.WATER_BUCKET, Sound.ENTITY_PLAYER_SPLASH, PotionEffectType.WATER_BREATHING, PotionEffectType.DOLPHINS_GRACE),
    ...
    ICE("Ice", "#00FFFF", 1006, Particle.SNOWFLAKE, Material.ICE, Sound.BLOCK_GLASS_PLACE, PotionEffectType.SLOWNESS, PotionEffectType.FROST_WALKER), // Note: Resistance to Slowness is custom-handled
